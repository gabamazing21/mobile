...
const String endpoint = "https://vpn.nerdvpn.id"; //<= Replace with yours
...
const String vpnExtensionIdentifier = "com.kenya.vpn.VPNExtensions";
const String groupIdentifier = "group.com.kenya.vpn.";
